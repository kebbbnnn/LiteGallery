...
import github.com.kebbbnnn.lightgallery.adapter.GalleryAdapter.ViewHolder;
...
public class GalleryLoader extends SimpleItemLoader<Long, Bitmap> {
  ...
  private Bitmap decodeSampledBitmapFromResource(Uri imageUri, int reqWidth, int reqHeight) {
    InputStream is = null;
    try {
